...
import ProductoTecnologiaForm from '../ProductoTecnologiaForm/ProductoTecnologiaForm';
import ProductoTecnologiaData from '../ProductoTecnologiaData/ProductoTecnologiaData';
...
import { faSearch, faTimes,  faSync, faPlus, faEraser, faLaptop } from '@fortawesome/free-solid-svg-icons';
...
const ProductoTecnologia = () => {
    ...
    const selectedConsecutivo = useSelector((state) => !currentConsecutivo ? state.consecutivos.find((c) => c.prefijo === "TEC-") : null);
    ...
    return (
        <>
            <Row>
                <Col md="12">
                    <div className="heading mt-4 mb-4">
                        <h2 className="d-inline mt-4" >Tecnología</h2>
                ...
                <Col md="3">
                    ...
                    <FontAwesomeIcon icon={faLaptop} size="9x" className="text-white mt-5"/>
                    </div>
                </Col>
                <Col md="9">
                    <div className="content">
                        ...
                        <div className="table-wrapper">
                            ...
                            <ProductoTecnologiaData setShow={setShow} currentId={currentId} setCurrenteId={setCurrenteId} inputSearchTerm={inputSearchTerm} selectedTypeSearch={selectedTypeSearch} />
            ...
            <ProductoTecnologiaForm currentId={currentId} setCurrenteId={setCurrenteId} isOpen={show} setshow={setShow}  currentConsecutivo={currentConsecutivo} setCurrentConsecutivo={setCurrentConsecutivo} selectedConsecutivo={selectedConsecutivo}/>
        </>
    );
}

export default ProductoTecnologia;