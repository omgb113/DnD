...
const ProductoLimpiezaData = ({ setShow, currentId,  setCurrenteId, inputSearchTerm, selectedTypeSearch}) => {
        ...
        <Table className="text-center" striped>
            ...
            <tbody className="text-white">
                {productos.filter( producto => {
                    ...
                    if(producto.codigo.includes("LH-")){
...
export default ProductoLimpiezaData; 