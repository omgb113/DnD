...
import EventoForm from '../EventoForm/EventoForm';
...
import { faSearch, faTimes,  faSync, faPlus, faEraser, faUsers } from '@fortawesome/free-solid-svg-icons';
        ...
        <>
            <Row>
                ...
                <Col md="3">
                    ...
                    <FontAwesomeIcon icon={faUsers} size="9x" className="text-white mt-5"/>
                    </div>
                </Col>
                <Col md="9">
                    <div className="content">
                        ...
                        <div className="table-wrapper">
                            ...
                            <EventoData setShow={setShow} currentId={currentId} setCurrenteId={setCurrenteId} inputSearchTerm={inputSearchTerm} selectedTypeSearch={selectedTypeSearch} bitacoraData={bitacoraData} setBitacoraData={setBitacoraData} generarCodigoBitacora={generarCodigoBitacora} bitacoraConsecutivoData={bitacoraConsecutivoData}/>
            ...
            <EventoForm currentId={currentId} setCurrenteId={setCurrenteId} isOpen={show} setshow={setShow}  currentConsecutivo={currentConsecutivo} setCurrentConsecutivo={setCurrentConsecutivo} bitacoraData={bitacoraData} setBitacoraData={setBitacoraData} generarCodigoBitacora={generarCodigoBitacora} bitacoraConsecutivoData={bitacoraConsecutivoData}/>
        </>
    );
}
