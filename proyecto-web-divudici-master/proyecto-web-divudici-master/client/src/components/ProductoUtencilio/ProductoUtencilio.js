...
import ProductoUtencilioForm from '../ProductoUtencilioForm/ProductoUtencilioForm';
import ProductoUtencilioData from '../ProductoUtencilioData/ProductoUtencilioData';
...
import { faSearch, faTimes,  faSync, faPlus, faEraser, faUtensilSpoon } from '@fortawesome/free-solid-svg-icons';

const ProductoUtencilio = () => {
            ...
            <Row>
                <Col md="12">
                    <div className="heading mt-4 mb-4">
                        <h2 className="d-inline mt-4" >Equipos y Utensilios</h2>
                ...
                <Col md="3">
                    ...
                    <FontAwesomeIcon icon={faUtensilSpoon} size="9x" className="text-white mt-5"/>
                    </div>
                </Col>
                <Col md="9">
                    <div className="content">
                        ...
                        <div className="table-wrapper">
                            ...
                            <ProductoUtencilioData setShow={setShow} currentId={currentId} setCurrenteId={setCurrenteId} inputSearchTerm={inputSearchTerm} selectedTypeSearch={selectedTypeSearch} />
...
export default ProductoUtencilio;