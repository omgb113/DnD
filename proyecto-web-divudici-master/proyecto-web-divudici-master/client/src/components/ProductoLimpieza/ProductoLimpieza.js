...
import ProductoLimpiezaForm from '../ProductoLimpiezaForm/ProductoLimpiezaForm';
import ProductoLimpiezaData from '../ProductoLimpiezaData/ProductoLimpiezaData';
...
import { faSearch, faTimes,  faSync, faPlus, faEraser, faBroom } from '@fortawesome/free-solid-svg-icons';
            ...
            <Row>
                <Col md="12">
                    <div className="heading mt-4 mb-4">
                        <h2 className="d-inline mt-4" >Limpieza e Higiene</h2>
                ...
                <Col md="3">
                    ...
                    <FontAwesomeIcon icon={faBroom} size="9x" className="text-white mt-5"/>
                    </div>
                </Col>
                <Col md="9">
                    <div className="content">
                        ...
                        <div className="table-wrapper">
                            ...
                            <ProductoLimpiezaData setShow={setShow} currentId={currentId} setCurrenteId={setCurrenteId} inputSearchTerm={inputSearchTerm} selectedTypeSearch={selectedTypeSearch} />
...
export default ProductoLimpieza;