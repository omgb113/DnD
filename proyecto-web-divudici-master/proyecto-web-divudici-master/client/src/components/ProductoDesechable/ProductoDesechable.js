...
import ProductoDesechableForm from '../ProductoDesechableForm/ProductoDesechableForm';
import ProductoDesechableData from '../ProductoDesechableData/ProductoDesechableData';
...
import { faSearch, faTimes,  faSync, faPlus, faEraser, faRecycle } from '@fortawesome/free-solid-svg-icons';

const ProductoDesechable = () => {
    ...
    const selectedConsecutivo = useSelector((state) => !currentConsecutivo ? state.consecutivos.find((c) => c.prefijo === "DE-") : null);
    ...
    return (
        <>
            <Row>
                <Col md="12">
                    <div className="heading mt-4 mb-4">
                        <h2 className="d-inline mt-4" >Desechable y Empaques</h2>
                ...
                <Col md="3">
                    ...
                    <FontAwesomeIcon icon={faRecycle} size="9x" className="text-white mt-5"/>
                    </div>
                </Col>
                <Col md="9">
                    <div className="content">
                        ...
                        <div className="table-wrapper">
                            ...
                            <ProductoDesechableData setShow={setShow} currentId={currentId} setCurrenteId={setCurrenteId} inputSearchTerm={inputSearchTerm} selectedTypeSearch={selectedTypeSearch} />
            ...
            <ProductoDesechableForm currentId={currentId} setCurrenteId={setCurrenteId} isOpen={show} setshow={setShow}  currentConsecutivo={currentConsecutivo} setCurrentConsecutivo={setCurrentConsecutivo} selectedConsecutivo={selectedConsecutivo}/>
        </>
    );
}

export default ProductoDesechable;