...
const ProductoDesechableData = ({ setShow, currentId,  setCurrenteId, inputSearchTerm, selectedTypeSearch}) => {
        ...
        <Table className="text-center" striped>
            ...
            <tbody className="text-white">
                {productos.filter( producto => {
                    ...
                    if(producto.codigo.includes("DE-")){
...
export default ProductoDesechableData; 