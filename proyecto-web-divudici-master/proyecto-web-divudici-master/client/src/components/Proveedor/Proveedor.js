...
import ProveedorForm from '../ProveedorForm/ProveedorForm';
import ProveedorData from '../ProveedorData/ProveedorData';
...
import { faSearch, faTimes,  faSync, faPlus, faEraser, faPeopleCarry } from '@fortawesome/free-solid-svg-icons';
        ...
        <>
            <Row>
                ...
                <Col md="3">
                    ...
                    <FontAwesomeIcon icon={faPeopleCarry} size="9x" className="text-white mt-5"/>
                    </div>
                </Col>
                <Col md="9">
                    <div className="content">
                        ...
                        <div className="table-wrapper">
                            ...
                            <ProveedorData setShow={setShow} currentId={currentId} setCurrenteId={setCurrenteId} inputSearchTerm={inputSearchTerm} selectedTypeSearch={selectedTypeSearch} />
            ...
            <ProveedorForm currentId={currentId} setCurrenteId={setCurrenteId} isOpen={show} setshow={setShow}  currentConsecutivo={currentConsecutivo} setCurrentConsecutivo={setCurrentConsecutivo} />
        </>
    );
}
