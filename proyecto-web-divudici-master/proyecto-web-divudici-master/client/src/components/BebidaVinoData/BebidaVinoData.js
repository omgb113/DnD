...
const BebidaVinoData = ({ setShow, currentId,  setCurrenteId, inputSearchTerm, selectedTypeSearch}) => {
            ...
            <tbody className="text-white">
                {bebidas.filter( bebida => {
                    ...
                    if(bebida.codigo.includes("V-")){
                        ...
                        }else if(selectedTypeSearch === "anno"){

                            if(bebida.annoCosecha.toString().includes(inputSearchTerm)){
                                return bebida;
                            }
                        ...
                        }else if(selectedTypeSearch === "precio"){

                            if(bebida.precioUnitario.toString().includes(inputSearchTerm) || bebida.precioBotella.toString().includes(inputSearchTerm) ){
                                return bebida;
                            }
                    ...
                    return(
                        <tr key={bebida._id}>
                            ...
                            <td key={bebida.annoCosecha}>{bebida.annoCosecha}</td>
                            <td>
